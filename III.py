...
def train_and_scale_models(data, features):
    ...
    tibia_xgb = XGBRegressor(**{**xgb_params_tibia, 'n_estimators': int(xgb_params_tibia['n_estimators']), 'max_depth': int(xgb_params_tibia['max_depth'])}, random_state=1)
    tibia_gbr = GradientBoostingRegressor(**{**gbr_params_tibia, 'n_estimators': int(gbr_params_tibia['n_estimators']), 'max_depth': int(gbr_params_tibia['max_depth'])}, random_state=1)
    femur_xgb = XGBRegressor(**{**xgb_params_femur, 'n_estimators': int(xgb_params_femur['n_estimators']), 'max_depth': int(xgb_params_femur['max_depth'])}, random_state=1)
    femur_gbr = GradientBoostingRegressor(**{**gbr_params_femur, 'n_estimators': int(gbr_params_femur['n_estimators']), 'max_depth': int(gbr_params_femur['max_depth'])}, random_state=1)
